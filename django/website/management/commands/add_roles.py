...
class Command(BaseCommand):
  ...
  def handle(self, *args, **options):
    studentRoles = ['add_calendarmodel', 'add_materialmodel', 'add_mentoringrequestmodel', 'add_mentoringmodel'] #TODO: Check if User or Profile is needed: change_user or change_profilemodel
